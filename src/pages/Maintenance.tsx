...
const Maintenance = () => {
  ...
  return (
    <DashboardLayout title="Manutenção e Reparos">
        ...
        <Card className="border-none shadow-sm bg-white">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900">2 Chamados</h3>
            </div>
          </CardContent>
        </Card>
        <Card className="border-none shadow-sm bg-white">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900">1 Ativo</h3>
            </div>
          </CardContent>
        </Card>
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-bold text-gray-900">{m.propertyName}</h3>
                      <span className="text-gray-300">•</span>
                      <span className={`text-xs font-bold uppercase tracking-wider ${getPriorityColor(m.priority)}`}>
                ...
                <div className="flex items-center justify-between md:justify-end gap-4 border-t md:border-none pt-4 md:pt-0">
                  ...
                  <div className="flex gap-1">
                    <Button variant="ghost" size="icon" className="rounded-full hover:bg-blue-50 hover:text-blue-600" onClick={() => { setSelectedMaintenance(m); setIsModalOpen(true); }}>
