          ...
          <div className="xl:col-span-8">
            <Card className="premium-card rounded-[2.5rem] border-none p-8">
              <CalendarUI
                ...
                classNames={{
                  ...
                  day: "h-10 w-10 p-0 font-bold text-slate-900 rounded-2xl hover:bg-blue-50 hover:text-blue-600 transition-all",
            ...
            <div className="mt-10 space-y-6">
              <div className="flex items-center gap-2 mb-2 px-2">
                ...
                <h3 className="text-sm font-bold text-slate-400 uppercase tracking-widest">Visão Geral do Dia</h3>
              </div>
                ...
                {events.slice(0, 2).map((event, i) => (
                  <div key={i} className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex items-center gap-5 group cursor-pointer hover:border-blue-100 transition-all">
                    <div className={cn(
                      ...
                      event.type === 'maintenance' ? "bg-amber-50 text-amber-600" : "bg-blue-50 text-blue-600"
                    )}>
