...
<dyad-write path="src/components/financial/billing-summary/BillingSummaryPreview.tsx" description="Adiciona overflow-hidden no container do preview para garantir que ele respeite a altura máxima do modal">
"use client";
...
export const BillingSummaryPreview = ({
  ...
  return (
    <div className="bg-slate-900 p-6 md:p-8 flex flex-col h-full flex-1 min-h-0 overflow-hidden">
