...
<dyad-chat-summary>Recuperando inquilino Marivaldo e adicionando aba de ex-inquilinos</dyad-chat-summary>

Recuperei o inquilino Marivaldo Souza como ex-inquilino com sua dívida ativa, adicionei abas de status na tela de inquilinos e melhorei o fluxo de exclusão para permitir arquivamento.<dyad-write path="src/pages/Dashboard.tsx" description="Atualizando o Dashboard para incluir ex-inquilinos com dívidas ativas nos indicadores e tabelas de atraso.">
"use client";
...
const Dashboard = () => {
  ...
  const getDaysOverdue = (tenant: any) => {
    ...
    // 2. Verificar faturas projetadas (aluguel do mês atual que já venceu - apenas para ativos)
