          ...
          >
            {isUploading ? (
              ...
              <>
                ...
                <p className="text-sm font-black text-slate-400 group-hover:text-blue-600">Clique para selecionar foto</p><dyad-write path="src/components/modals/property-steps/PhotoStep.tsx" description="Finalizando a etapa de upload e identidade visual do imóvel.">
"use client";
