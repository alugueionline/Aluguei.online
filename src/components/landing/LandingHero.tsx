      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-5 space-y-10 animate-in fade-in slide-in-from-left-8 duration-700">
            ...
            <div className="flex items-center gap-8 pt-4 opacity-0 animate-in fade-in duration-1000 delay-500 fill-mode-forwards">
          ...
          <div className="lg:col-span-7 relative animate-in fade-in slide-in-from-right-8 duration-1000">
            ...
            <div className="relative bg-white rounded-[2.5rem] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.14)] border border-slate-100 overflow-hidden">
              ...
              {/* Floating Cards with CSS Animation */}
              <div className="absolute top-12 -left-8 bg-white p-4 rounded-2xl shadow-2xl border border-slate-50 hidden xl:block animate-float">
              ...
              <div className="absolute bottom-12 -right-8 bg-white p-4 rounded-2xl shadow-2xl border border-slate-50 hidden xl:block animate-float-delayed">
                <div className="flex items-center gap-3">
